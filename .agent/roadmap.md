...
| M4 | Multi-agent quality | P4 | 🟡 partially — Debugger (ADR-015) and Browser QA (ADR-016: Playwright validation stage, console-error strictness, commit gate; 158 offline+browser tests) pulled forward and shipped; Reviewer/Context/Curator still open | measurable quality delta on 10-task fixture suite; reviewer catches seeded regression |
