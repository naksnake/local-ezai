...
def create_app(settings: ControlConfig, ctx: PlatformContext | None = None, *,
    ...
    def openapi() -> dict[str, Any]:
        ...
        schema["info"]["x-contract-status"] = (
            "1.2.0 — additive over the surface frozen at 1.0.0 (P2 phase close, ADR-028 "
            "Accepted): PR-19 added the project memory operations, PR-23 the first-run report; "
            "a surface change bumps the version: additive → minor, breaking → major")
